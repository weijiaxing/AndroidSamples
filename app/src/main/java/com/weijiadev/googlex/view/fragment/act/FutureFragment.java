...
public class FutureFragment extends BaseFragment {
    ...
    @BindView(R.id.tl_act_future)
    TabLayout mViewpagerTab;
    @BindView(R.id.vp_act_future)
    ViewPager mNewsViewpager;

    @Override
    protected int attachLayoutRes() {
        return R.layout.fragment_act_future;
    }
    ...
    protected void initViews() {
        ...
        list_fragment.add(new ActFutureAllFragment());
        list_fragment.add(new ActFutureLpFragment());
